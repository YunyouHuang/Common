...
/**
 * Created by hdp on 16-12-18.
 */
public class ElectricProfile2V implements Serializable {
    ...
    public ElectricProfile2V(){

    }

    public  ElectricProfile2V(String profile) {
        String[] profiles;
        if (profile.contains(",")){
        ...
        for (int i= 7; i <profiles.length; i++) {
            ...
            points.add(Float.parseFloat(profiles[i]));
        }
    }
